...
createApp(App).use(router).mount('#app')import { createRouter, createWebHistory } from 'vue-router'
import App from './App.vue'
...
createApp(App).use(router).mount('#app')            <h2>Fake Yiban 1.0.0</h2>
            <p>By <a href='https://github.com/just-it-O/yibanzhengshiban.git'>just-it-O</a></p>
